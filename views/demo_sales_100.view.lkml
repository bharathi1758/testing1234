...
view: demo_sales_100 {
  derived_table: {
    sql: {% raw %} SELECT 'SALE001' sale_id,'CUST001' customer_id,'ABC Technologies' customer_name,'Laptop' product_name,'Electronics' category,'West' region,'2024-01-15' sale_date,125000 sales_amount,5 quantity,'Completed' status
      ...
      UNION ALL
      SELECT 'SALE008','CUST004','Future Retail','Cloud Subscription','Software','East','2024-03-22',150000,12,'Completed'
      UNION ALL
      ...
      UNION ALL
      SELECT 'SALE017','CUST013','Tech Solutions','Laptop','Electronics','West','2024-06-12',145000,7,'Completed'
      UNION ALL
      SELECT 'SALE018','CUST013','Future Retail','Printer','Electronics','North','2024-06-20',47000,4,'Completed'
      UNION ALL
      ...
      UNION ALL
      SELECT 'SALE030','CUST027','Vision Corp',
      ...
      UNION ALL
      SELECT 'SALE033','CUST031','Sunrise Traders',
