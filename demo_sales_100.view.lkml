...
view: demo_sales_100 {
  derived_table: {
    sql: {% raw %} SELECT 'SALE001' sale_id,'CUST001' customer_id,'ABC Technologies' customer_name,'Laptop' product_name,'Electronics' category,'West' region,'2024-01-15' sale_date,125000 sales_amount,5 quantity,'Completed' status
      ...
      UNION ALL
      SELECT 'SALE007','CUST007','Tech Solutions','Server','Electronics','South','2024-03-15',210000,2,'Completed'
      UNION ALL
      SELECT 'SALE008','CUST008','Future Retail','Cloud Subscription','Software','East','2024-03-22',150000,12,'Completed'
      UNION ALL
      ...
      UNION ALL
      SELECT 'SALE012','CUST012','Global Retail Ltd','Desk','Furniture','East','2024-04-26',38000,5,'Completed'
      UNION ALL
      ...
      UNION ALL
      SELECT 'SALE016','CUST016','Prime Industries','Cloud Subscription','Software','East','2024-06-03',140000,11,'Completed'
      UNION ALL
      ...
      UNION ALL
      SELECT 'SALE020','CUST020','Vision Corp','Desk','Furniture','East','2024-07-10',41000,6,'Completed'
      UNION ALL
      ...
      UNION ALL
      SELECT 'SALE023','CUST023','Sunrise Traders','Server','Electronics','South','2024-08-05',205000,2,'Completed'
      UNION ALL
      ...
      UNION ALL
      SELECT 'SALE027','CUST027','Tech Solutions',
      ...
      UNION ALL
      SELECT 'SALE029','CUST029','Skyline Ltd',
      'Software License','Software','West',
      '2024-10-01',118000,10,'Completed'
      
      UNION ALL
      SELECT 'SALE030','CUST030','Vision Corp',
      ...
      UNION ALL
      SELECT 'SALE033','CUST033','Sunrise Traders',
      ...
      UNION ALL
      SELECT 'SALE035','CUST035','Innovate Labs',
      'Office Chair','Furniture','South',
      ...
      UNION ALL
      SELECT 'SALE038','CUST038','Future Retail',
      'Monitor','Electronics','North',
      ...
      UNION ALL
      SELECT 'SALE042','CUST042','Global Retail Ltd',
      'Printer','Electronics','North',
      ...
      UNION ALL
      SELECT 'SALE045','CUST045','Innovate Labs',
      'Software License','Software','West',
      ...
      UNION ALL
      SELECT 'SALE047','CUST047','Tech Solutions',
      'Server','Electronics','South',
      '2025-03-20',240000,2,'Completed'
      
      UNION ALL
      SELECT 'SALE048','CUST048','Future Retail',
      'Cloud Subscription','Software','East',
      ...
      UNION ALL
      SELECT 'SALE050','CUST050','Vision Corp',
      'Printer','Electronics','North',
      ...
      UNION ALL
      SELECT 'SALE052','CUST052','Global Retail Ltd',
      'Desk','Furniture','East',
      ...
      UNION ALL
      SELECT 'SALE054','CUST054','Metro Services',
      'Monitor','Electronics','North',
      ...
      UNION ALL
      SELECT 'SALE056','CUST056','Prime Industries',
      'Cloud Subscription','Software','East',
      ...
      UNION ALL
      SELECT 'SALE058','CUST058','Future Retail',
      'Printer','Electronics','North',
      ...
      UNION ALL
      SELECT 'SALE060','CUST060','Vision Corp',
      'Desk','Furniture','East',
      ...
      UNION ALL
      SELECT 'SALE062','CUST062','Global Retail Ltd',
      'Monitor','Electronics','North',
      ...
      UNION ALL
      SELECT 'SALE064','CUST064','Metro Services',
      'Cloud Subscription','Software','East',
      ...
      UNION ALL
      SELECT 'SALE069','CUST069','Skyline Ltd',
      'Software License','Software','West',
      ...
      UNION ALL
      SELECT 'SALE076','CUST076','Prime Industries',
      'Desk','Furniture','East',
      ...
      UNION ALL
      SELECT 'SALE083','CUST083','Sunrise Traders',
      'Office Chair','Furniture','South',
      ...
      UNION ALL
      SELECT 'SALE091','CUST091','ABC Technologies',
      'Office Chair','Furniture','South',
      ...
      UNION ALL
      SELECT 'SALE093','CUST093','Sunrise Traders',
      'Software License','Software','West',
      ...
      UNION ALL
      SELECT 'SALE098','CUST098','Future Retail',
      'Printer','Electronics','North',
